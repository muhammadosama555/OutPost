...
export default function Security() {
    ...
    const { mutate: changePasswordMutate,isSuccess: ChangePasswordIsSuccess } = useChangePassword();
    ...
    return (
            ...
            <div className='px-8 py-6'>
                ...
                <div className='pt-4 pl-5'>
                    ...
                    <div className='mt-4  mx-4 w-4/5 rounded-lg overflow-hidden shadow-sm'>
                        <div onClick={openChangePasswordHandler} className='cursor-pointer bg-stone-50 hover:bg-gray-100 border-b border-gray-200 px-4 py-3 flex items-center justify-between'><span className='font-medium text-gray-600'>Change Password</span><NavigateNextOutlinedIcon style={{ color: "gray" }} /></div>
        ...
        >
            <div className={`${openChangePassword ? "" : "hidden"} fixed inset-0 z-40 right-0 left-0 top-0 flex items-center justify-center w-screen h-screen`}>
                <div className='p-6 bg-white absolute w-[500px] rounded-2xl shadow-xl overflow-hidden'>
                    <div className='flex justify-end w-full'>
                        <div className='cursor-pointer flex items-center justify-center w-12 h-12'>
                            <CloseOutlinedIcon onClick={closeChangePasswordHandler}/>
                        </div>
                    </div>
                    <div>
                    ...
                    <div className='w-full'>
                        <div className='settings-box flex w-full mt-4'>
                            ...
                            <div className="w-full">
                                {['Current password', 'New password'].map(name => (
                                    <div className='relative mt-3 h-14 rounded-lg border overflow-hidden' >
                                        <input
                                            type='password'
                                            name={name}
                                            ...
                                            ref={name === 'Current password' ? oldPasswordInputElement : newPasswordInputElement}
                                        />
                                ...
                                <button  onClick={handleSubmit} className='bg-blue-600 w-full text-white py-2 px-4 rounded-3xl '>Change Password</button>
                            </div>
                        </div>
                    </div>
