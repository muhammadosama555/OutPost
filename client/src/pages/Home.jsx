  ...
  return (
    <>
      ...
      <div className='flex justify-between pt-14 '>
        <div className='left-side-bar pt-8 w-[320px]  border-r border-gray-200'>
          <div className='fixed space-y-2'>
            <div className='w-[320px]'>
              <Link to={'Profile'}>
                <div className='profile flex items-center gap-4 hover:bg-gray-100 rounded-lg mx-4 px-3 py-2 hover:font-bold hover:cursor-pointer hover:transition-all ease-in-out'>
                  ...
                  <p className='tracking-wide w-full'>UserName</p>
                </div>
              </Link>
            </div>
            <div className='search flex items-center gap-3 hover:bg-gray-100 rounded-lg mx-4 px-3 py-1 hover:font-bold hover:cursor-pointer hover:transition-all ease-in-out'>
            ...
            <div className='Explore flex items-center pt-1 gap-3 hover:bg-gray-100 rounded-lg mx-4 px-3 py-1 hover:font-bold hover:cursor-pointer hover:transition-all ease-in-out'>
              <div className='w-12 h-12 flex items-center justify-center'>
                <svg aria-label="Explore" className="w-6 h-6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={24} role="img" viewBox="0 0 24 24" width={24}><polygon fill="none" points="13.941 13.953 7.581 16.424 10.06 10.056 16.42 7.585 13.941 13.953" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /><polygon fillRule="evenodd" points="10.06 10.056 13.949 13.945 7.581 16.424 10.06 10.056" /><circle cx="12.001" cy="12.005" fill="none" r="10.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} /></svg>
