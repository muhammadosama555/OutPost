                ...
                <div className="flex flex-col h-screen bg-white">
                    ...
                    return (
                      <div onClick={()=>conversationHandler(conversation._id)} key={conversation._id} className='cursor-pointer card px-5 py-2 hover:bg-gray-100 flex items-center gap-2'>
                        <div className='img w-16 h-16 bg-gray-400 rounded-full '
                         style={{
                        ...
                        <div className="flex-1 right  flex flex-col justify-between pb-4">
                            <div className='flex-1 overflow-y-auto'>
                                <div className='header flex fixed bg-white justify-between w-[56%] border-b border-gray-200 py-3 px-4'>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="img w-14 h-14 bg-gray-400 rounded-full"
                                        style={{
                            ...
                            backgroundRepeat: 'no-repeat',
                                        ...
                                        <h2 className="text-gray-800 font-semibold">{otherUser?.username}</h2>
                                    </div>
                                        ...
                                        <input
                                         type="text"
                                          ...
                                          <div className='flex items-center'>
                                            ...
                                            <span onClick={submitMessageHandler} className='hover:cursor-pointer p-2'><svg aria-label="Send Message"
                  className="x1lliihq x1n2onr6"
                  color="rgb(0, 0, 0)"
                  fill="rgb(0, 0, 0)"
                  height={24}
